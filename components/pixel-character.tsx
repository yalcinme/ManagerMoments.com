...
export default function PixelCharacter({ isMoving, variant, size = "medium" }: PixelCharacterProps) {
  const sizeClasses = {
    small: "w-12 h-12",
    medium: "w-16 h-16",
    large: "w-24 h-24",
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full bg-slate-900 border-2 border-slate-600 rounded-sm overflow-hidden">
        ...
        {/* Legs */}
        <div className="absolute bottom-0 left-1/4 w-1/4 h-1/4 bg-orange-300 border border-slate-700" />
        <div className="absolute bottom-0 right-1/4 w-1/4 h-1/4 bg-orange-300 border border-slate-700" />
